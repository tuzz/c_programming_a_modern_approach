...
// Removes an item from the beginning of the queue. Returns 0 if the queue is empty.
Item queue_pop_front(Queue q);

// Returns the first item in the queue without changing the queue. Returns 0 if the queue is empty.
Item queue_first(Queue q);

// Returns the last item in the queue without changing the queue. Returns 0 if the queue is empty.
